...
def make_gif(args, t1s, supermask):
    ...
    prefix = ['', args.dataset, args.subject,
              args.mask_type, args.template, str(int(args.fwh)), args.extra]
    ...
    frame_1 = frames[0]
    frame_1.save(gif_filename, format='GIF', append_images=frames,
...
def parse_args():
    ...
    parser.add_argument('--mask-type', default='',
                        choices=('union', 'intersection', 'raw'))
